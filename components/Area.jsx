...
function Area() {
  ...
  return (
    <>
      <div class="relative flex flex-col content-center justify-baseline gap-20 w-screen h-screen bg-linear-to-b from-[#211C17] to-[#BA7123] font-poppins max-md:py-auto">
        <h1 class="text-white font-aguafina mt-27 text-4xl">Coffee Spot</h1>
        <div class="slider-container relative">
          <Slider ref={sliderRef} {...settings}>
            <AreaCom
              area={{
                url: "../src/img/Area/Area 1.png",
                title: "Indoor Area",
